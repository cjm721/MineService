...
namespace TestingProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            byte[] publicKeyBytes = new byte[550];

            clientSocket.GetStream().Read(publicKeyBytes, 0, 550);
            ...
            System.Diagnostics.Debug.WriteLine(System.Text.Encoding.UTF8.GetString(publicKeyBytes));
        }
